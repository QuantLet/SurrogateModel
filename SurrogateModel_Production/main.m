...
l=6; % initial width of the domain
...
%yes, it restricts the bound to be within. 
     ...
     if count==0
        data.params_values(11,1)=0;
         data.params_values(11,2)=3;
         data.params_values(12,2)=4;
         data.params_values(12,1)=0;
         data.p_trial=[2.5,2.5,0,0];
